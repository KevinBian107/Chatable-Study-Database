...
CONFIG = {
    ...
    "TOP_K_DEFAULT": 5,
    "TOP_K_MAX": 10,
    "FAISS_NLIST": 650,  # Adjusted based on dataset size
    "LOG_LEVEL": "INFO",
    ...
    "MAX_RETRIES": 5,
    "BACKOFF_FACTOR": 2,
    "FEEDBACK_LOG": "logs/feedback.log",  # Path to store feedback
}
...
def main():
    ...
    if CONFIG["CACHE_ENABLED"]:
        save_embeddings_pickle(enriched_embeddings, CONFIG["EMBEDDINGS_PICKLE"])
    ...
    while True:
        try:
            ...
            conversation_history.append({"prompt": user_prompt, "answer": answer})
            ...
            # Log feedback
            log_feedback(user_prompt, answer, rating, feedback_text)
